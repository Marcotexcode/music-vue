...
Route::middleware('can:haUnaBand')->group(function () {
    ...
    // Sidebar
    Route::get('/sidebar/lista-utente', [SidebarController::class, 'listaUtente'])  ->name('locandina.lista-utente');
    Route::get('/sidebar/lista-pagine', [SidebarController::class, 'listaPagine'])  ->name('locandina.lista-pagine');
    Route::post('/sidebar/filtro',      [SidebarController::class, 'filtro'])       ->name('locandina.filtro');
